...
exports.getTotalBookings = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched total bookings', count);
});
...
exports.getSuccessRidesCount = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched success rides', count);
});
...
exports.getCancelledRidesCount = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched cancelled rides', count);
});
...
exports.getIncompleteRidesCount = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched incomplete rides', count);
});
...
exports.getDriverNotFoundCount = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched driver not found', count);
});
...
exports.getTotalCustomers = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched total customers', customers.length);
});
...
exports.getTopVehicle = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched top vehicle', result[0] || null);
});
...
exports.getTopPaymentMethod = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched top payment method', result[0] || null);
});
...
exports.getHighestFare = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched highest fare', result[0] || null);
});
...
exports.getLowestFare = catchAsync(async (req, res) => {
  ...
  sendResponse(res, 200, true, 'Fetched lowest fare', result[0] || null);
});

// GET /stats/bookings-by-vehicle
exports.getBookingsByVehicle = catchAsync(async (req, res) => {
  const result = await statsService.aggregate([
    { $group: { _id: '$Vehicle_Type', count: { $sum: 1 } } },
    { $sort: { count: -1 } }
  ]);
  sendResponse(res, 200, true, 'Fetched bookings by vehicle', result);
});

// GET /stats/bookings-by-month
exports.getBookingsByMonth = catchAsync(async (req, res) => {
  const result = await statsService.aggregate([
    { $group: { _id: '$Month', count: { $sum: 1 } } },
    { $sort: { _id: 1 } }
  ]);
  sendResponse(res, 200, true, 'Fetched bookings by month', result);
});
